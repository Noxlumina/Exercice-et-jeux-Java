...
public class Exo4 {
    ...
    /**
     * Méthode sui demande de taper trois chiffres puis qui donne le plus grand des trois
     */
    public void troisNombre(){
        ...
        if (valeur1>valeur2) System.out.println("le plus grand chiffre est : " + plusgrand2);
    }
}
